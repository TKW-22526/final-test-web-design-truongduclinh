const products = [
    ...
    {id:"05", name:"Giày bóng đá loại A", price:850, image:"../assets/images/giayboadia.JPG", description:"Giày bóng đá loại A chất liệu cao cấp, đế chắc chắn, thiết kế giống bóng, phù hợp sân cỏ tự nhiên và sân cỏ nhân tạo. Chất liệu da tổng hợp, mũi giày thiết kế đúc để bảo vệ ngón chân.", productLink:"detail.html"},
    {id:"06", name:"Giày bóng chuyền loại A", price:650, image:"../assets/images/giayongchuyena.JPG", description:"Giày bóng chuyền loại A êm tay, độ bền cao, dành cho tập luyện và thi đấu chuyên nghiệp. Chất liệu mesh thoáng khí, đệm giày êm ái, phù hợp cho sân trong nhà.", productLink:"detail.html"}
];
